// API endpoint for deleting a look
import { Request, Response } from 'express';
import * as LookPersistence from '../../domain/look-persistence/index.js';

export async function deleteLookHandler(req: Request, res: Response): Promise<void> {
  try {
    ...
    await LookPersistence.deleteLook(id, userId);
